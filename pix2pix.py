...
parser.add_argument("--flip", type=utils.str2bool, dest="flip", action="store_true", help="flip images horizontally")
parser.add_argument("--no_flip", type=utils.str2bool, dest="flip", action="store_false", help="don't flip images horizontally")
